    ...
    <div className="bg-cream font-sans text-ink antialiased">
      ...
      <ListingView
        breadcrumb={[
          ...
          { label: category?.name ?? "Toilet" },
        ]}
        title="Toilet"
        description="Toilets and WC suites — in stock at the Abuja showroom or made to order."
        products={products}
        emptyMessage={listingEmptyMessage(
          allProducts.length,
          "No Toilet pieces published yet — check back soon.",
        )}
