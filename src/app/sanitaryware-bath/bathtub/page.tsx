...
export default async function BathtubPage({
  searchParams,
}: {
    ...
    <div className="bg-cream font-sans text-ink antialiased">
      ...
      <ListingView
        breadcrumb={[
          ...
          { label: category?.name ?? "Bath" },
        ]}
        title="Bath"
        description="Freestanding and built-in bathtubs — in stock at the Abuja showroom or made to order."
        products={products}
        emptyMessage={listingEmptyMessage(
          allProducts.length,
          "No Bath pieces published yet — check back soon.",
        )}
