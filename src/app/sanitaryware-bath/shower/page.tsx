...
export default async function ShowerPage({
  searchParams,
}: {
  ...
  return (
    <div className="bg-cream font-sans text-ink antialiased">
      ...
      <ListingView
        breadcrumb={[
          { label: "Home", href: "/" },
          { label: "Sanitarywares & Bath Accessories", href: "/sanitaryware-bath" },
          { label: category?.name ?? "Shower" },
        ]}
        title="Shower"
        description="Shower enclosures, trays and fittings — in stock at the Abuja showroom or made to order."
        products={products}
        emptyMessage={listingEmptyMessage(
          allProducts.length,
          "No Shower pieces published yet — check back soon.",
        )}
